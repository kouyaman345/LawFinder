...
1.スクレイピングした全法令データをローカルに保存。  
2.保存したデータから、すべての参照(html リンク)を検出し  
3.neo4j マッピングを作成。

ここで得られたデータベースは基本データベースとなります。

1.基本データベース
e-gov のスクレイピングから得られたデータベース。データべースの出発点（基礎）

2.追加データベース
法令の改正により、法令データベースの追加がなされる。
追加分の参照更新は独自アルゴリズムにより参照検出を実施する。
